...
@Component({
  ...
  template: `
    <ul class="flex flex-col gap-y-4 p-2">
      ...
      <li class="flex items-center uppercase transition-all duration-300 ease-in-out bg-red-600 rounded-md shadow-md hover:bg-red-500  shadow-gray-800/50 dark:shadow-black">
