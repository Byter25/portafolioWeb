    ...
    this.frameworks = [
      {
        id: 1,
        name: 'Tailwind CSS',
        icon: 'svg/frameworks/tailwind-css.svg',
        LenguajesId: [2], // IDs de los lenguajes
      },
      {
        id: 2,
        name: 'Bootstrap',
        icon: 'svg/frameworks/bootstrap.svg',
        LenguajesId: [1, 2, 3],
      },
      {
        id: 3,
        name: 'Spring Boot',
        icon: 'svg/frameworks/spring-boot.svg',
        LenguajesId: [4],
      },
      {
        id: 4,
        name: '.NET',
        icon: 'svg/frameworks/net.svg',
        LenguajesId: [5],
      },
      {
        id: 5,
        name: 'Angular',
        icon: 'svg/frameworks/angular.svg',
        LenguajesId: [1, 2, 6],
      },
      {
        id: 6,
        name: 'Astro',
        icon: 'svg/frameworks/astro.svg',
        LenguajesId: [3, 9],
      },
      {
        id: 7,
        name: 'Express',
        icon: 'svg/frameworks/express-js.svg',
        LenguajesId: [3],
      },
    ];

    this.lenguajes = [
      { id: 1, name: 'HTML', icon: 'svg/lenguajes/html.svg' },
      { id: 2, name: 'CSS', icon: 'svg/lenguajes/css.svg' },
      {
        id: 3,
        name: 'JavaScript',
        icon: 'svg/lenguajes/javascript.svg',
      },
      { id: 4, name: 'Java', icon: 'svg/lenguajes/java.svg' },
      { id: 5, name: 'C#', icon: 'svg/lenguajes/csharp.svg' },
      {
        id: 6,
        name: 'TypeScript',
        icon: 'svg/lenguajes/typescript.svg',
      },
    ];
